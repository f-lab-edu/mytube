...
public class VideoServiceImpl implements VideoService {
   ...
   */
  public void uploadVideo(MultipartFile multipartFile, String userId, String title, String detailContents) {
    ...
    try {
      ...
      log.error("insertVideo 메서드에서 file 처리 중 에러가 발생했습니다, 자세한 에러 내용 : " + e);
