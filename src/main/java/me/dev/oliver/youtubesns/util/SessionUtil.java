...
/**
 * Service단과 분리 시키기 위해 사용됨. Service단에서는 Sevlet의 존재를 알필요가 없음.
 * Session은 로그인 뿐만 아니라 장바구니 구현 등에도 사용될 수 있기 때문에 확장의 가능성이 있음.
 * 상태 정보 유지의 행위를 추상화.
 *
 * 
...
public class SessionUtil {
   ...
   * @param key session name을 지정.
   */
  public static void getAttribute(String key) {

    getHttpSession().getAttribute(key);
  }
